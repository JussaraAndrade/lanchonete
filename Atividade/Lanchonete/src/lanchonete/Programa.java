...
public class Programa {
	...
	public static void menu() {
		...
		case 3:
			...
			massa((Macarrao) macarrao, lanche, macarrao, pizza);
			break;
		case 4:
	...
	public static void massa(Massa massa, Lanche lanche, Macarrao macarrao, Pizza pizza) {
	...
	public static void sanduiche(Sanduiche lanche, Lanche lancheSanduiche) {
		...
		String sanduiche_cardapio[] = { "Pão", "Queijo", "Maionese", "Tomate", "Alface", "Ovo", "Peite de Peru",
				"Cebola", "Picles", "Ketchup" };
		String ingrediente = "";
		int i = 0;
		double preco;
		int distancia, quantidade;
	...
	public static void bolo(Bolo bolo, Lanche lanche) {
		...
		ingredientes_cobertura = teclado.next();

		System.out.println("Digite a massa: ");
		ingredientes_massa = teclado.next();

		System.out.println("Digite o recheio: ");
		ingredientes_recheio = teclado.next();
